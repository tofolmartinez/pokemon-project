...
class PokemonOption_Scene
  ...
  def pbChangeSelection
    ...
    if hash
      ...
      description = _INTL("Cerrar la pantalla.")
    end
...
MenuHandlers.add(:options_menu, :bgm_volume, {
  "name"        => _INTL("Volumen de la música"),
  "order"       => 10,
  "type"        => SliderOption,
...
MenuHandlers.add(:options_menu, :se_volume, {
  "name"        => _INTL("Volumen de los efectos"),
  "order"       => 20,
  "type"        => SliderOption,
  "parameters"  => [0, 100, 5],   # [minimum_value, maximum_value, interval]
...
MenuHandlers.add(:options_menu, :text_speed, {
  ...
  "order"       => 30,
  "type"        => EnumOption,
  "parameters"  => [_INTL("Lenta"), _INTL("Normal"), _INTL("Rápida")],
...
MenuHandlers.add(:options_menu, :battle_animations, {
  "name"        => _INTL("Animaciones de combate"),
  "order"       => 40,
  "type"        => EnumOption,
  "parameters"  => [_INTL("Sí"), _INTL("No")],
  "description" => _INTL("Elige si quieres ver las animaciones de los movimientos en combate."),
...
MenuHandlers.add(:options_menu, :battle_style, {
  ...
  "order"       => 50,
  "type"        => EnumOption,
  "parameters"  => [_INTL("Cambiar"), _INTL("Mantener")],
  "description" => _INTL("Eligwe si cambiar o no de Pokémon cuando el del oponente se debilita."),
...
MenuHandlers.add(:options_menu, :movement_style, {
  ...
  "order"       => 60,
  "type"        => EnumOption,
  "parameters"  => [_INTL("Caminar"), _INTL("Correr")],
  "description" => _INTL("Elige tu velocidad de movimiento. Mantén Retroceso mientras te mueves para moverte a la otra velocidad."),
...
MenuHandlers.add(:options_menu, :send_to_boxes, {
  "name"        => _INTL("Enviar a Cajas"),
  "order"       => 70,
  "type"        => EnumOption,
  "parameters"  => [_INTL("Manual"), _INTL("Automático")],
  "description" => _INTL("Elige si los Pokémon capturados son enviados a las cajas cuando tu equipo está completo."),
...
MenuHandlers.add(:options_menu, :give_nicknames, {
  ...
  "description" => _INTL("Elige si dar motes a los Pokémon cuando los capturas."),
...
MenuHandlers.add(:options_menu, :speech_frame, {
  "name"        => _INTL("Caja de diálogo"),
  "order"       => 90,
  "type"        => NumberOption,
  "parameters"  => 1..Settings::SPEECH_WINDOWSKINS.length,
  "description" => _INTL("Elige el aspecto de las cajas de diálogo."),
...
MenuHandlers.add(:options_menu, :menu_frame, {
  "name"        => _INTL("Cajas de Menú"),
  "order"       => 100,
  "type"        => NumberOption,
  "parameters"  => 1..Settings::MENU_WINDOWSKINS.length,
  "description" => _INTL("Elige el aspecto de las cajas de menú."),
...
MenuHandlers.add(:options_menu, :text_input_style, {
  ...
  "description" => _INTL("Elige como quieres introducir texto."),
...
MenuHandlers.add(:options_menu, :screen_size, {
  "name"        => _INTL("Tamaño de la pantalla"),
  "order"       => 120,
  "type"        => EnumOption,
  "parameters"  => [_INTL("S"), _INTL("M"), _INTL("L"), _INTL("XL"), _INTL("Completo")],
