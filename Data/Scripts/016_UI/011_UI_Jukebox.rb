...
class PokemonJukeboxScreen
  ...
  def pbStartScreen
    ...
    cmdCustom  = -1
    cmdTurnOff = -1
    commands[cmdMarch = commands.length]   = _INTL("Reproducir: Marcha Pokémon")
    commands[cmdLullaby = commands.length] = _INTL("Reproducir: Nana Pokémon")
    commands[cmdOak = commands.length]     = _INTL("Reproducir: Oak")
    commands[cmdCustom = commands.length]  = _INTL("Reproducir: Personalizado...")
    commands[cmdTurnOff = commands.length] = _INTL("Parar")
