...
class PokemonTrainerCard_Scene
  ...
  def pbDrawTrainerCardFront
    ...
    textPositions = [
      [_INTL("Nombre"), 34, 70, 0, baseColor, shadowColor],
      [$player.name, 302, 70, 1, baseColor, shadowColor],
      [_INTL("No. ID"), 332, 70, 0, baseColor, shadowColor],
      [sprintf("%05d", $player.public_ID), 468, 70, 1, baseColor, shadowColor],
      [_INTL("Dinero"), 34, 118, 0, baseColor, shadowColor],
      ...
      [_INTL("Tiempo"), 34, 214, 0, baseColor, shadowColor],
      [time, 302, 214, 1, baseColor, shadowColor],
      [_INTL("Empezó"), 34, 262, 0, baseColor, shadowColor],
